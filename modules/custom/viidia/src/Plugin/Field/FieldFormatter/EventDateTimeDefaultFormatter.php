...
/**
 * Plugin implementation of the 'Default' formatter for 'eventdatetime' fields.
 *
 * @FieldFormatter(
 ...
 * )
 */
class EventDateTimeDefaultFormatter extends EventDateTimeFormatterBase
{
    ...
    public function viewElements(FieldItemListInterface $items, $langcode)
    {
        ...
        foreach ($items as $delta => $item) {
            ...
            if ($item->start_date) {
                ...
                $outputStart = $this->formatDate($date);
            }
            ...
            if ($item->end_date) {
                ...
                $outputEnd = $this->formatDate($date);
            }

            $arrOutput = [];
            if (!empty($outputStart)) {
                $arrOutput[] = $outputStart;
            }
            if (!empty($outputEnd)) {
                $arrOutput[] = $outputEnd;
            }

            $output = implode(' - ', $arrOutput);
